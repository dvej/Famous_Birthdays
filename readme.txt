...
Add from List - read names from 'Enter list..' box and try to get their birthdays from Wikipedia.
...
Example 1: 'm% m%' in field Name could give results like [Marko Marković, Miljan Miljanić, Mitar Mrkela]
Example 2: '196%' in field Year could give results like [1963, 1965, 1968]
...
bdays.db - database file (automatically created if not exist)
bdays.html - graph file of birthdays distibution (automatically created if not exist)
